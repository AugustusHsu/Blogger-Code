...
def setup_model():
    ...
    G_opt = tf.keras.optimizers.Adam(FLAGS.lr, 0.5)
...
def main(argv):
    ...
    plot_line(df, col_name, 'cgan', figname='probability')
    col_name = ['Gen_loss', 'Dis_loss']
    plot_line(df, col_name, 'cgan', figname='loss')
